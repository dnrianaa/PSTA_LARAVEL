...
<div class="polman-nav-static-right collapse scrollstyle" id="menu">
    <div id="accordions" role="tablist" aria-multiselectable="true">
        <div class="list-group">
            ...
            <a href='/DashboardMahasiswa' class='list-group-item list-group-item-action' style='border-radius: 0px; border: none; padding-left: 22px; display: inherit;'>
                <i class='fa fa-home fa-lg fa-pull-left'></i>Dashboard
            </a>

            <a href='/DashboardPesyaratan_Pendaftaran' class='list-group-item list-group-item-action' style='border-radius: 0px; border: none; padding-left: 22px; display: inherit;'>

                <i class="dropdown-menu"></i>Pesyaratan Pendaftaran

            </a>
            <a href='/DashboardPendaftaran_Sidang' class='list-group-item list-group-item-action' style='border-radius: 0px; border: none; padding-left: 22px; display: inherit;'>

<i class="dropdown-menu"></i>Pendaftaran Sidang

</a>
<a href='/DashboardHasil_Sidang' class='list-group-item list-group-item-action' style='border-radius: 0px; border: none; padding-left: 22px; display: inherit;'>

<i class="dropdown-menu"></i>Hasil Sidang
